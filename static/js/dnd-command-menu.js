const commonStyles = 'flex items-center gap-x-2 p-1 rounded-md hover:bg-zinc-800';
const menuHtml = `
<div class="option-for-property select-none cursor-pointer absolute min-w-32 p-2 gap-y-2 font-medium text-zinc-300 bg-zinc-900 border border-zinc-800 rounded-md dropdown-menu-for-item z-20 text-xs">
