...
const menuHtml = `
<div class="option-for-property absolute min-w-32 p-2 gap-y-2 font-medium text-zinc-400 bg-zinc-900 border border-zinc-800 rounded-md dropdown-menu-for-item z-20 text-xs">
