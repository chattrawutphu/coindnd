const commonStyles = 'flex items-center gap-x-2 p-1 rounded-md hover:bg-gray-800';
const menuHtml = `
<div class="option-for-property absolute min-w-32 p-2 gap-y-2 font-medium text-gray-400 bg-gray-900 border border-gray-800 rounded-md dropdown-menu-for-item z-20 text-xs">
