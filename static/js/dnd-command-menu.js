const commonStyles = 'flex items-center gap-x-2 p-1 rounded-md hover:dark:bg-primary-800 hover:bg-primary-200';
const menuHtml = `
<div class="option-for-property select-none cursor-pointer absolute min-w-32 p-2 gap-y-2 font-medium dark:text-primary-300 text-primary-700 dark:bg-primary-900 bg-primary-100 border dark:border-primary-800 border-primary-300 rounded-md dropdown-menu-for-item z-20 text-xs">
