...
var classesModel = {
    ...
    //Property Input
    inputContainerClasses: "w-full max-w-full  text-ellipsis whitespace-nowrap bg-gray-50 dark:text-gray-300 text-gray-800 text-sm rounded-lg block p-1.5 dark:bg-[#333337]",
