...
export function appendEventButton() {
    ...
    $('[data-class="panelWrapperClasses"]').each(function() {
        ...
        if ($next.length === 0 && $childPanelWrappers.length > 0) {
            ...
            const parrentId = $current.attr('dnd-id')
    
            // Create the new button element
            var $newButton = $(`
                <div data-class="addEventBuntton" dnd-id="${parrentId}" dnd-type="container" class="min-w-[32rem] hidden col-[span_30/span_30] bg-[#dcdcdc] dark:bg-[#333337] rounded-[0.2rem] text-xs p-1.5 m-[1px] dark:text-gray-500 text-gray-800 ${marginClass}">
                    <div class="flex">
